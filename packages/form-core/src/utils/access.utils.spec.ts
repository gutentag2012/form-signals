...
describe("access.utils", () => {
  describe("pathToParts", () => {
    ...
    it.each([
      ["a.b.c", ["a", "b", "c"]],
      ["a", ["a"]],
    ])("should return an array for path elements separated with a dot %j should be %j", (path, expected) => {
  ...
  describe("setValueAtPath", () => {
    it("should do nothing for an undefined object", () => {
      expect(setValueAtPath(undefined, "a" as never, 1 as never)).toBe(undefined);
    })
