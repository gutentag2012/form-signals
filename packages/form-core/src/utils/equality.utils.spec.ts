...
describe('equality.utils', () => {
  ...
  describe('getLeftUnequalPaths', () => {
    ...
    it.each([
      ...
      [
        { nestedArray: [1, undefined, null, new Date(), {deeply: {nested: ["object", "missing"]}}] },
        { nestedArray: [1, undefined, null, new Date(1), {deeply: {nested: ["objectt"]}}] },
        ["nestedArray.3", "nestedArray.4.deeply.nested.0", "nestedArray.4.deeply.nested.1"],
      ],
    ])(
