...
import {
  ...
  unSignalifyValue, unSignalifyValueSubscribed
} from "./signals.utils";
...
describe("signals.utils", () => {
  describe("deepSignalifyValue", () => {
    it.each([
      ...
      undefined,
      new Date(),
    ])("should signalify a simple value %j", (val) => {
    ...
    it("should signalify a nested object", () => {
      ...
      expect(signalified.value.deep.value.nested.value[0].signal.value[0].signal.value.object.value).toBe(object.deep.nested[0][0].object);
    })
  })
  ...
  describe("getSignalValueAtPath", () => {
    ...
    it("should return value for array path", () => {
      ...
      expect(getSignalValueAtPath(val, "a.0")).toEqual(val.value.a.value[0].signal);
    })
  })
  describe('removeSignalValueAtPath', () => {
    ...
    it("should do nothing for an undefined path", () => {
      ...
      expect(removeSignalValueAtPath(obj, undefined as never)).toEqual(undefined);
    })
  ...
  describe('setSignalValueAtPath', () => {
    ...
    it("should do nothing for an undefined path", () => {
      const obj = deepSignalifyValue({})
      expect(setSignalValueAtPath(obj, undefined as never, 1 as never)).toEqual(undefined);
