...
function App() {
  ...
  return (
    <form.FormProvider>
      ...
      >
        <form.FieldProvider name="name" validator={value => !value && "This field is required!"}>
          {field => (
            <div>
              <label>Name:</label>
        ...
        <form.FieldProvider name="email" validator={value => !value && "This field is required!"}>
          {field => (
            <div>
              <label>Email:</label>
        ...
        <form.FieldProvider name="dateOfBirth" transformToBinding={dateToString} transformFromBinding={e => new Date(e)}>
          {field => (
            <div>
        ...
        <button type="submit" disabled={!form.canSubmit.value}>Submit</button>
      </form>
    </form.FormProvider>
  )
}
...
export function InputSignal({data, ...props}: InputSignalProps) {
  return <input {...props} value={data.value} onChange={(e) => {
