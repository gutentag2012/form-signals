      ...
      <form.Provider>
        ...
        >
          ...
          <form.Field
            name="name"
            validators={{
              onBlur: z.string().min(3).max(45),
            }}
          >
            {(field) => (
              <FormTextInput field={field} label="Name" maxLength={45} />
            )}
          </form.Field>
                  ...
                  validators={{
                    ...
                    onChange: z
                      ...
                      .refine(
                        ...
                        'At least one price must be configured',
                      ),
                  }}
                  children={(prices) => (
                    <>
              ...
              <TableCaption>
                <form.Subscribe
                  ...
                  children={(prices) => {
                    ...
                    const pluralisedCurrency =
                      populatedCurrencyCount !== 1
                        ? 'currencies are'
                        : 'currency is'
                    return (
                      <>
                        Currently {populatedCurrencyCount} {pluralisedCurrency}{' '}
                        configured
                      </>
                    )
                  }}
...
const FormTextInput = <TName,>({
  field,
  label,
  maxLength,
}: { field: FieldApi<Product, TName>; label: string; maxLength?: number }) => {
  return (
    <div>
